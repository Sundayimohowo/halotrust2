...
Route::get('{activity}/editclone', [ActivityController::class, 'editclone'])->name('activity.editclone');
Route::post('clone', [ActivityController::class, 'clone'])->name('activity.clone');